...
uniform sampler2D left; //texunit:0
uniform sampler2D right; //texunit:1
/* clang-format on */
...
void main() {
    ...
    frag_color = vec4(1,0,0,1);//vec4(leftFrag.rgb * rightFrag.rgb, 1.0); 
}
